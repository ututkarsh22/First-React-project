        ...
        <nav className="h-[10vh]  flex justify-between">
            ...
            <ul className="flex w-[40vw] font-bold justify-evenly items-center gap-10">
                ...
                <div className='flex justify-around items-center mr-3 h-[70%] w-40 text-white'>
                    <button className='bg-red-600 w-[40%] p-1 rounded-lg font-bold hover:bg-black hover:text-white hover:transition-all hover:duration-700 hover:ease-in-out'>
                    Guider
                    </button>
                    <button className='bg-red-500 w-[40%] p-1 rounded-lg font-bold  hover:bg-black hover:text-white hover:transition-all hover:duration-700 hover:ease-in-out'>
                    Tourist
                    </button>
                </div>
            </div>
